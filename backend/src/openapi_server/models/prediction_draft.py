...
class PredictionDraft(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "title", "data", "createdAt", "updatedAt"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PredictionDraft from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PredictionDraft from a dict"""
        if obj is None:
            return None
