...
class ChannelAnalyticsDemographicsTopCountriesInner(BaseModel):
    """
    ChannelAnalyticsDemographicsTopCountriesInner
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["country", "countryCode", "percentage"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ChannelAnalyticsDemographicsTopCountriesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ChannelAnalyticsDemographicsTopCountriesInner from a dict"""
        if obj is None:
            return None
