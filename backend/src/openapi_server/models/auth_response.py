...
from openapi_server.models.auth_response_tokens import AuthResponseTokens
...
class AuthResponse(BaseModel):
    ...
    tokens: Optional[AuthResponseTokens] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "tokens": AuthResponseTokens.from_dict(obj.get("tokens")) if obj.get("tokens") is not None else None
        })
        return _obj
