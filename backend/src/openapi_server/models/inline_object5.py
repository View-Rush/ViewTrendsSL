...
from openapi_server.models.inline_object5_error import InlineObject5Error
try:
...
class InlineObject5(BaseModel):
    ...
    error: Optional[InlineObject5Error] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "error": InlineObject5Error.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
