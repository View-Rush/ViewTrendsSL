...
class PredictionDetailAllOfViewsTimeline(BaseModel):
    """
    PredictionDetailAllOfViewsTimeline
    """ # noqa: E501
    var_date: Optional[date] = Field(default=None, alias="date")
    views: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["date", "views"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PredictionDetailAllOfViewsTimeline from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PredictionDetailAllOfViewsTimeline from a dict"""
        if obj is None:
            return None
