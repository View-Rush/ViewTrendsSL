...
class ChannelsMeSyncPost200ResponseData(BaseModel):
    """
    ChannelsMeSyncPost200ResponseData
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["syncId", "status", "estimatedCompletionTime"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in ('pending', 'in_progress', 'completed', 'failed',):
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ChannelsMeSyncPost200ResponseData from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ChannelsMeSyncPost200ResponseData from a dict"""
        if obj is None:
            return None
