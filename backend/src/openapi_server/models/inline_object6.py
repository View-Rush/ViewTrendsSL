...
from openapi_server.models.inline_object6_error import InlineObject6Error
try:
...
class InlineObject6(BaseModel):
    ...
    error: Optional[InlineObject6Error] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "error": InlineObject6Error.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
