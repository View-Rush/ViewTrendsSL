...
from openapi_server.models.inline_object2_error import InlineObject2Error
try:
...
class InlineObject2(BaseModel):
    ...
    error: Optional[InlineObject2Error] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "error": InlineObject2Error.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
