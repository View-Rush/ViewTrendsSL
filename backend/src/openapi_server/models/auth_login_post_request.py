...
class AuthLoginPostRequest(BaseModel):
    ...
    email: StrictStr
    password: SecretStr
    remember_me: Optional[StrictBool] = Field(default=None, description="Extend token expiration time", alias="rememberMe")
    __properties: ClassVar[List[str]] = ["email", "password", "rememberMe"]
