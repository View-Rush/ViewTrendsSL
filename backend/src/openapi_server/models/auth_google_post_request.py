...
class AuthGooglePostRequest(BaseModel):
    """
    AuthGooglePostRequest
    """ # noqa: E501
    id_token: StrictStr = Field(description="Google OAuth ID token", alias="idToken")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AuthGooglePostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of AuthGooglePostRequest from a dict"""
        if obj is None:
            return None
