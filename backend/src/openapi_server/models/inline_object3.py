...
from openapi_server.models.inline_object3_error import InlineObject3Error
try:
...
class InlineObject3(BaseModel):
    ...
    error: Optional[InlineObject3Error] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "error": InlineObject3Error.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
