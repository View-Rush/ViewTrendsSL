...
class ChannelsMeSettingsGet200Response(BaseModel):
    """
    ChannelsMeSettingsGet200Response
    """ # noqa: E501
    success: Optional[StrictBool] = None
    data: Optional[ChannelSettings] = None
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ChannelsMeSettingsGet200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ChannelsMeSettingsGet200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "data": ChannelSettings.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
