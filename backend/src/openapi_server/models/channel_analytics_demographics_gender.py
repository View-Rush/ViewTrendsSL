...
class ChannelAnalyticsDemographicsGender(BaseModel):
    """
    ChannelAnalyticsDemographicsGender
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["male", "female", "other"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ChannelAnalyticsDemographicsGender from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ChannelAnalyticsDemographicsGender from a dict"""
        if obj is None:
            return None
