...
from openapi_server.models.inline_object_error import InlineObjectError
try:
...
class InlineObject(BaseModel):
    ...
    error: Optional[InlineObjectError] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "error": InlineObjectError.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
