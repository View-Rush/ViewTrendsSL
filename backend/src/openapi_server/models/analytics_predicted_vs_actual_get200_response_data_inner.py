...
class AnalyticsPredictedVsActualGet200ResponseDataInner(BaseModel):
    """
    AnalyticsPredictedVsActualGet200ResponseDataInner
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["predictionId", "predictedViews", "actualViews", "category", "accuracy"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AnalyticsPredictedVsActualGet200ResponseDataInner from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of AnalyticsPredictedVsActualGet200ResponseDataInner from a dict"""
        if obj is None:
            return None
