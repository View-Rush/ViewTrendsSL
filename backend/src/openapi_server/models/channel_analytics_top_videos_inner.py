...
class ChannelAnalyticsTopVideosInner(BaseModel):
    """
    ChannelAnalyticsTopVideosInner
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["videoId", "title", "views", "thumbnail"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ChannelAnalyticsTopVideosInner from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ChannelAnalyticsTopVideosInner from a dict"""
        if obj is None:
            return None
