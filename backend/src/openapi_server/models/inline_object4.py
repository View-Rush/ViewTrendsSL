...
from openapi_server.models.inline_object4_error import InlineObject4Error
try:
...
class InlineObject4(BaseModel):
    ...
    error: Optional[InlineObject4Error] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "error": InlineObject4Error.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
