...
from openapi_server.models.health_get200_response_services import HealthGet200ResponseServices
try:
...
class HealthGet200Response(BaseModel):
    ...
    services: Optional[HealthGet200ResponseServices] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "services": HealthGet200ResponseServices.from_dict(obj.get("services")) if obj.get("services") is not None else None
        })
        return _obj
