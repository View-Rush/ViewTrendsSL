...
from openapi_server.models.inline_object1_error import InlineObject1Error
try:
...
class InlineObject1(BaseModel):
    ...
    error: Optional[InlineObject1Error] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "error": InlineObject1Error.from_dict(obj.get("error")) if obj.get("error") is not None else None
        })
        return _obj
