...
from openapi_server.models.user_stats import UserStats
try:
    from typing import Self
except ImportError:
    from typing_extensions import Self

class UsersMeStatsGet200Response(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of UsersMeStatsGet200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of UsersMeStatsGet200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "data": UserStats.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
