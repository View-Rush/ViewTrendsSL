...
class NotificationsGet200Response(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["success", "data", "pagination", "unreadCount"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of NotificationsGet200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of NotificationsGet200Response from a dict"""
        if obj is None:
            return None
