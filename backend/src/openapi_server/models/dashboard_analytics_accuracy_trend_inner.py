...
class DashboardAnalyticsAccuracyTrendInner(BaseModel):
    """
    DashboardAnalyticsAccuracyTrendInner
    """ # noqa: E501
    var_date: Optional[date] = Field(default=None, alias="date")
    accuracy: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["date", "accuracy"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of DashboardAnalyticsAccuracyTrendInner from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of DashboardAnalyticsAccuracyTrendInner from a dict"""
        if obj is None:
            return None
